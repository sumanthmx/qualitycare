 ...
 const names = ['Transparency', 'Verifiable Certifications and Accreditations',
  ...
  return (
    <div className = "flex flex-col min-h-screen relative">
        <div className = "bg-white h-92 py-16 flex flex-col sm:flex-row">
            <div className="w-full sm:w-2/5 font-helvetica-neue sm:ml-10 sm:mr-0 text-center sm:text-left">
                <span className="text-blue-400 text-xl sm:text-2xl font-bold">Your Gateway <span className="text-blue-950 text-xl sm:text-2xl font-bold">To World Class Health Care</span></span>
            ...
            <img src="/globe.png" alt="Home Globe Pic" className="w-16 h-72 hidden sm:block sm:w-3/5 mr-4 ml-2 object-cover"/>
        </div>
        <div className = "bg-blue-950 h-92 py-16">
        ...
        <div className = "bg-slate-200 h-54 font-helvetica-neue py-8">
            ...
            <div className="flex items-center justify-center mt-6">
                <input type="text" placeholder="Type your email address"
                       className="text-center border border-gray-300 rounded-l py-2 px-6
                       focus:outline-none focus:ring-2 focus:ring-blue-500"/>
                <button
                    className="text-center bg-blue-950 text-white rounded-r py-0 sm:py-2
                    px-6 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Sign Up
                </button>
            </div>
        </div>
