    ...
    <div className = "flex flex-col min-h-screen">
      <div className="bg-blue-950 pt-20 text-white flex flex-col items-center justify-center">
          ...
          <div className="flex flex-wrap justify-center pt-10 -mb-1">
            <button
              className={`${openTab === 'why' ? 'bg-white' : 'bg-gray-300 hover:bg-white'} w-full md:w-auto flex items-center justify-center text-blue-950 font-helvetica-neue py-3 px-6 md:px-28 rounded-md mr-3 mb-3 md:mb-0`}
              onClick={() => setTab('why')}
            >
              Why
            </button>
            <button
              className={`${openTab === 'how' ? 'bg-white' : 'bg-gray-300 hover:bg-white'} w-full md:w-auto flex items-center justify-center text-blue-950 font-helvetica-neue py-3 px-6 md:px-28 rounded-md mr-3 mb-3 md:mb-0`}
              onClick={() => setTab('how')}
            >
              How
            </button>
            <button
              className={`${openTab === 'what' ? 'bg-white' : 'bg-gray-300 hover:bg-white'} w-full md:w-auto flex items-center justify-center text-blue-950 font-helvetica-neue py-3 px-6 md:px-28 rounded-md mr-3 mb-3 md:mb-0`}
              onClick={() => setTab('what')}
            >
              What
            </button>
        ...
        {openTab === 'why' && <div className="bg-white py-20 text-blue-950 flex flex-col items-center justify-center">
            ...
            <ol className="list-decimal mt-12">
              ...
              <li className="relative pl-6 py-2 flex items-center">
                <div className="w-full md:w-3/5 mx-8 md:mx-0 text-center md:text-left">
        ...
        <ol className={`ml-20 list ${styles.ols}`}>
     ...
     <div className="relative bg-sky-100 h-112">
